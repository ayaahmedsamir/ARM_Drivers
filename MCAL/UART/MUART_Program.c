...
// define array of pointers to function
static void (*USART_Callback[3])(void);
...
void MUART_voidInit(void)
{
	...
	UART1->CR1.UE=HIGH;
	/*To enable interrupt*/
	UART1->CR1.TXEIE=HIGH;
	/*To enable transmission iterrupt*/
	UART1->CR1.TCIE=HIGH;
	/*To enable receive interrupt*/
	UART1->CR1.RXNEIE=HIGH;
...
void UART1_SetCallBack(pf ptr)
{
	USART_Callback[0]=ptr;
}

void UART2_SetCallBack(pf ptr)
{
	USART_Callback[1]=ptr;
}

void UART6_SetCallBack(pf ptr)
{
	USART_Callback[2]=ptr;
}
...
void USART1_IRQHandler(void)
{
	...
	CLR_BIT(UART1->USART_SR,READ_REG_NOT_EMPTY);
